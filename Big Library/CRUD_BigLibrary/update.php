<?php 
    ...
    if ($_GET['id']) {
        ...
        echo $sql = "SELECT * FROM media WHERE ID_Media = '$id'";
        ...
        <div class="main">
            ...
            <form action="actions/a_update.php"  method="post">
                <table cellspacing="0" cellpadding= "0">
                    <tr>
                        <th>ID_Media</th>
                        <td><input type="number" name="ID_Media" placeholder="ID_Media" value="<?php echo $data['ID_Media'] ?>" /></td>
                    </tr>    
                    <tr>
                        <th>Cover</th>
                    ...
                    <tr>
                        <th>Publish date</th>
                        <td><input  type="date" name= "Publish_Date" placeholder="Publish_Date" value="<?php echo $data['Publish_Date'] ?>" /></td>
                    </tr>
                    <tr>

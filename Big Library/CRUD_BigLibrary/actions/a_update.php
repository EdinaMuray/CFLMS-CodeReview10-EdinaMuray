...
<?php 
    ...
    if ($_POST) {
        ...
        $sql = "UPDATE media SET ID_Media = '$id', Cover = '$cover', FirstName = '$fname', LastName = '$lname', Title = '$title', ISBN = '$isbn', Short_Description = '$description', Type = '$type', Status = '$status', Publisher = '$publ', Adress = '$address', Size = '$size', Publish_Date = '$publ_date' 
        WHERE ID_Media = '$id'";

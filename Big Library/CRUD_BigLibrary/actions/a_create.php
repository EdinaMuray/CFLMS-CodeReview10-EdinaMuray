...
<?php 
    ...
    $sql = "INSERT INTO media (Cover, FirstName, LastName, Title, ISBN, Short_Description, Type, Status, Publisher, Adress, Size, Publish_Date) VALUES ('$cover', '$fname', '$lname', '$title', '$isbn', '$description', '$type', '$status', '$publ', '$address', '$size', '$publ_date')";
